...
int main(int argc, char *argv[]){
	...
	double	trn_inpts_2[4][3] = {{0,0,0},{1,0.5,0.5},{1,0,0},{0.4,0,0}};
	double	otpts_2[4] = {0,0,1,1};
	
	double	trn_inpts_3[4][3] = {{0.8,0,0.2},{0.4,0.3,0.8},{0.7,0.2,0},{0.4,0.8,0.3}};
	double	otpts_3[4] = {1,0,1,0};
										
	
	printf("How many times of iterations per training would you like to have? There will be three training sesseons.\n");
	scanf(" %ud", &itrt);
	...
	printf("AI has just done %d times of training. Now please make your choice: \n",itrt * 3);
